<!--
  ...
  <div>Hello,</div>
  <br>
  <div>A new user has been invited to the team <b><a href="https://github.com/orgs/@githubOrg@/teams/@githubTeam@">@githubTeam@</a></b>.</div>
  <br>
  ...
  <div>Regards,</div>
  <br>
  <div>Pucmm Eict GitHub Invitations</div>
