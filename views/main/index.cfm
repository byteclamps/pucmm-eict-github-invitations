    ...
    <div class="flex-col flex items-center m-10">
		...
		<form class="shadow-md rounded px-8 pt-6 pb-8 mb-4 m-10 w-1/2 bg-white" id="github-form" method="post" action="/Main/check">
			...
			<div class="mb-4">
				...
				<input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" id="githubUser" name="githubUser" placeholder="Your github valid username" value="#rc.githubUser#"/>
			</div>
			<div class="mb-4">
		...
		<span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© #now().year()# <a href="https://ghencon.com/" class="hover:underline">Ghencon™</a>. All Rights Reserved. Version #rc.version#</span>
	</div>
</cfoutput>
